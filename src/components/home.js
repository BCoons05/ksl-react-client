...
export default class Home extends Component {
    ...
    fetchKSL = (year, make, model, minMiles, maxMiles) => {
        request(`https://desolate-escarpment-31867.herokuapp.com/https://cars.ksl.com/search/make/${make}/model/${model}/yearFrom/${year}/yearTo/${year}/mileageFrom/${minMiles}/mileageTo/${maxMiles}/titleType/Clean+Title/page/0`, (error, response, html) => {
